...
set CLASSPATH=%APP_HOME%\lib\PiVision2024-all.jar

@rem Execute PiVision2024
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PI_VISION2024_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%PI_VISION2024_EXIT_CONSOLE%" exit 1
exit /b 1
